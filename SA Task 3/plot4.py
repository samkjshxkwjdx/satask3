...
fig = px.line(df, x="Year", y="Oil consumption(m³)", color='Entity', title='Worldwide oil consumption')

fig.update_layout(
    paper_bgcolor="#283618",
    plot_bgcolor="#283618",
    xaxis=dict(title=dict(text="Year", font=dict(color="#fefae0")), tickfont=dict(color="#fefae0"), showgrid=False),
    yaxis=dict(title=dict(text="Oil consumption (m³)", font=dict(color="#fefae0")), tickfont=dict(color="#fefae0"), showgrid=False),
    title=dict(text="Worldwide oil consumption", font=dict(color="#fefae0")),
